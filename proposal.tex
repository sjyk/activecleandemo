...
In such settings, analysts often resort to iterative data cleaning \ewu{ref trifacta and other companies?} as described in this paper, 
...
Our key insight is that an important and broad class of predictive models, called loss models (e.g., linear regression and SVMs\ewu{LDA?  etc?}), 
