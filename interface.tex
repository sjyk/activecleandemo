...
\centering
 ...
 \caption{Cleaning Interface. The analyst can choose to remove data, \ewu{ write a custom cleaning operation, or automatically clean the data using an existing cleaning operation.}}
\end{figure}
